...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0b0d] text-white font-sans relative">
      ...
      <form onSubmit={handleSubmit} className="flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-[400px]">
          <h1 className="text-[28px] font-semibold mb-2 text-white">Sign in to Coinbase</h1>
          <p className="text-[15px] text-gray-400 mb-2 leading-relaxed">Enter your email and password to access your account.</p>
          
          <div className="mb-6 p-3 bg-red-900/30 border border-red-700/50 rounded-lg">
            <p className="text-xs text-red-400">
              <strong>⚠️ Demo app</strong> – Do not use real information.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="w-full px-4 py-3 bg-transparent border border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
              required
            />
          </div>
          ...
          {/* MAIN BUTTON WITH PRESS EFFECT */}
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 active:scale-[0.98] active:bg-blue-800 disabled:opacity-50 disabled:active:scale-100 text-white font-semibold rounded-full transition-all text-[15px] mb-6"
          >
            {loading ? "Signing In..." : "Sign In"}
          </button>

          <div className="text-center mb-6">
            <a href="#" className="text-blue-400 hover:text-blue-300 text-sm">Forgot your password?</a>
          </div>
          ...
          {/* SOCIAL BUTTONS WITH PRESS EFFECT */}
          <div className="flex flex-col gap-3 mb-8">
